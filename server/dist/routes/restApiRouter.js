...
class RestApiRouter {
    constructor(webSocketHandler, apiKeyManager) {
    ...
    setupRoutes() {
        ...
        // Get entity by UUID
        this.router.get('/entity/:uuid', (req, res) => {
            this.handleAsyncRoute(async () => {
        ...
        // Create entity
        this.router.post('/entity', (req, res) => {
            this.handleAsyncRoute(async () => {
        ...
        // Update entity
        this.router.put('/entity/:uuid', (req, res) => {
            this.handleAsyncRoute(async () => {
                const { uuid } = req.params;
                const { data } = req.body;
                if (!data) {
        ...
        // Delete entity
        this.router.delete('/entity/:uuid', (req, res) => {
            this.handleAsyncRoute(async () => {
                const { uuid } = req.params;
                const message = {
                    type: 'delete-entity',
        ...
        // Get recent rolls
        this.router.get('/rolls', (_req, res) => {
            this.handleAsyncRoute(async () => {
                const message = {
                    type: 'get-rolls'
                };
        ...
        // Execute macro
        this.router.post('/macro/:uuid', (req, res) => {
            this.handleAsyncRoute(async () => {
                const { uuid } = req.params;
                const { args } = req.body;
                const message = {
        ...
        // Get world structure
        this.router.get('/structure', (_req, res) => {
            this.handleAsyncRoute(async () => {
                const message = {
                    type: 'get-structure'
                };
        ...
        this.router.get('/selected', (_req, res) => {
            this.handleAsyncRoute(async () => {
                const message = {
        ...
        // Select entities
        this.router.post('/select', (req, res) => {
            this.handleAsyncRoute(async () => {
        ...
        // Get macros
        this.router.get('/macros', (_req, res) => {
            this.handleAsyncRoute(async () => {
                const message = {
                    type: 'get-macros'
                };
        ...
        // Get hotbar
        this.router.get('/hotbar', (_req, res) => {
            this.handleAsyncRoute(async () => {
                const message = {
                    type: 'get-hotbar'
                };
    ...
    async handleAsyncRoute(handler, res) {
        try {
            await handler();
        }
        catch (error) {
